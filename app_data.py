...
def get_request_conf():
    ...
    for row in student_ids :
        ...
        count+= 1
    return render_template('club_create/request_detail.html', request_detail=request_detail, leader_mail=leader_mail, student_mail_list=student_mail_list, club_id=club_id)
